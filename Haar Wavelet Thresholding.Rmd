...
for (i in 1:4) {
  ...
  A[i,c((((3*(2^(i)-1))+1)):(length(a)-(3*((2^(i))-1))))] <- a[(2*(3*((2^(i))-1))) : (length(a)-1)]
}
...
for(i in 1:4){
  m <- 3*(2^(i)-1)+1
  for (n in m:70){
    D[i,(n-(ceiling((m-1)*.5)))] <- (g3*A[i,(n-3*2^(i-1))])+ (g2*A[i,(n-2*2^(i-1))])+(g3*A[i,(n-2^(i-1))])+(g0*A[i,n])
    }
}
...
for (i in 1:4) {
  ...
  A_unthresh[i,c((((3*(2^(i)-1))+1)-(2^i)):(length(a)-(2^i)-(3*((2^(i))-1))))] <- a[(2*(3*((2^(i))-1))) : (length(a)-1)]
  D_unthresh[i,c((((3*(2^(i)-1))+1)-(2^i)):(length(d)-(2^i)-(3*((2^(i))-1))))] <- d[(2*(3*((2^(i))-1))) : (length(d)-1)]
